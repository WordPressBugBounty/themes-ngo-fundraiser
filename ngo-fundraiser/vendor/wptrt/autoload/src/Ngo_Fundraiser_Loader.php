...
class Ngo_Fundraiser_Loader {
	 ...
	 * @return void
	 */
	public function ngo_fundraiser_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function ngo_fundraiser_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function ngo_fundraiser_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function ngo_fundraiser_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->ngo_fundraiser_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function ngo_fundraiser_load( $class ) {
